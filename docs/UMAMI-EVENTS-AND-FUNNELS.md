...
- Final verification reran `pnpm run build` after the checkout/notification/history-back fixes; it completed successfully with the same pre-existing optional wallet dependency warnings from Wagmi/Reown connectors.
